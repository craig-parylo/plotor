...
```{r warning=FALSE, fig.width=9, fig.height=4, fig.format='png'}
# using plot_or
...
```{r warning=FALSE, fig.width=9, fig.height=6, fig.format='png'}
plot_or(glm_model_results = lr) + 
...
```{r warning=FALSE, message=FALSE, fig.width=9, fig.height=4, fig.format='png'}
plot_or(glm_model_results = lr) + 
...
```{r warning=FALSE, message=FALSE, fig.width=9, fig.height=5, fig.format='png'}
